...
urlpatterns = [
    ...
    url(r'^leaders/create$', views.create_custom, name='create_custom'),
    url(r'^leaders/weekly_realm$', views.weekly_realm_leaders, name='weekly_realm_leaders'),
    url(r'^leaders/weekly_guild$', views.weekly_guild_leaders, name='weekly_guild_leaders'),
    url(r'^leaders/weekly_solo$', views.weekly_solo_leaders, name='weekly_solo_leaders'),
    ...
    url(r'^create_custom/$', views.create_custom),

...
urlpatterns = [
    ...
    url(r'^leaders/weekly_realm$', views.weekly_realm_leaders, name='weekly_realm'),
    url(r'^leaders/weekly_guild$', views.weekly_guild_leaders, name='weekly_guild'),
    url(r'^leaders/weekly_solo$', views.weekly_solo_leaders, name='weekly_solo'),
    url(r'^leaders/guild$', views.by_guild, name='guilds'),
    ...
    url(r'^guilds/$', views.by_guild, name='old_guilds'),
